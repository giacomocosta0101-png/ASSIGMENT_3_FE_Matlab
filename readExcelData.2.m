...
% CORREZIONE QUI: Uso cellfun invece di cell2mat
dates.depos = cellfun(@datenum, date_depositi);
...
% CORREZIONE QUI: Uso cellfun invece di cell2mat per entrambe le colonne
dates.futures(:,1) = cellfun(@datenum, date_futures_read(:,1));
dates.futures(:,2) = cellfun(@datenum, date_futures_read(:,2));

%Date relative to swaps: expiry dates
date_swaps = readcell(filename, 'Sheet', 1, 'Range', 'D39:D88');
% CORREZIONE QUI: Uso cellfun invece di cell2mat
dates.swaps = cellfun(@datenum, date_swaps);
