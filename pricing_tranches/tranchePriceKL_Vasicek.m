function price = tranchePriceKL_Vasicek(I, p, rho, LGD, Kd, Ku, disc_fact, notional)
% TRANCHEPRICEKL_VASICEK
%
% KL approximation of the price of a tranche [Kd, Ku] in
% the Vasicek model.
%
% INPUTS:
...
% Outer integral over Y ~ N(0,1)
     ...
     expectedLoss = quadgk(integrandY, -Inf, Inf);
% Tranche price
