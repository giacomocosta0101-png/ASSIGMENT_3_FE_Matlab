function price = tranchePriceExact_Vasicek(I, p, rho, LGD, Kd, Ku)
% TRANCHEPRICEEXACT_VASICEK
% 
% Computes the exact expected loss of a tranche [Kd, Ku] in the
...
%
% OUTPUT:
%   price : expected tranche loss, expressed as a fraction of the
%           tranche notional
%
% THEORY:
